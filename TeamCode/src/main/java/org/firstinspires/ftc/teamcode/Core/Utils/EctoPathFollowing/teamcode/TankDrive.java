package org.firstinspires.ftc.teamcode.Core.Utils.EctoPathFollowing.teamcode;
...
import  org.firstinspires.ftc.teamcode.Core.Utils.EctoPathFollowing.teamcode.messages.DriveCommandMessage;
import  org.firstinspires.ftc.teamcode.Core.Utils.EctoPathFollowing.teamcode.messages.PoseMessage;
import  org.firstinspires.ftc.teamcode.Core.Utils.EctoPathFollowing.teamcode.messages.TankCommandMessage;
import  org.firstinspires.ftc.teamcode.Core.Utils.EctoPathFollowing.teamcode.messages.TankLocalizerInputsMessage;
...
public final class TankDrive extends SubsystemBase {
    public static class Params {
        ...
        public double inPerTick = 0.0272184936614467;
        public double trackWidthTicks = 619.458862;

        // feedforward parameters (in tick units)
        public double kS = 3.2;
        public double kV = 0.00345;
        ...
        public double ramseteZeta = 0.4; // in the range (0, 1)
        public double ramseteBBar = 2.8; // positive

        // turn controller gains
        public double turnGain = 0.8;
    ...
    public TankDrive(HardwareMap hardwareMap, Pose2d pose) {
        ...
        leftMotors = Arrays.asList(hardwareMap.get(DcMotorEx.class, "chassisLeft"));
        rightMotors = Arrays.asList(hardwareMap.get(DcMotorEx.class, "chassisRight"));
    ...
    public final class FollowTrajectoryAction implements Action {
        ...
        public boolean run(@NonNull TelemetryPacket p) {
            ...
            if ((t >= timeTrajectory.duration && error.position.norm() < 2
                    && robotVelRobot.linearVel.norm() < 1.5)
    ...
    public final class TurnAction implements Action {
        ...
        public boolean run(@NonNull TelemetryPacket p) {
            ...
            if ((t >= turn.duration && error.position.norm() < 0.07
                    && robotVelRobot.linearVel.norm() < 0.3)
                    || t >= turn.duration + 1) {
                for (DcMotorEx m : leftMotors) {
                    m.setPower(0);
                }
