...
public class EctoPID {
     ...
     */
    public EctoPID(double kp, double ki, double kd) {
        this(kp, ki, kd, 0.01);
    }
     ...
     */
    public EctoPID(double kp, double ki, double kd, double period) {
        m_kp = kp;
        m_ki = ki;
        m_kd = kd;
    ...
    public void setSetpoint(double setpoint) {
        ...
        if (m_continuous) {
            ...
            m_positionError = EctoMath.inputModulus(m_setpoint - m_measurement, -errorBound, errorBound);
        } else {
